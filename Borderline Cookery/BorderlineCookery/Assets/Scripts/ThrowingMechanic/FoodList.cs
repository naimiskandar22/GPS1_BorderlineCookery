...
public class FoodList : MonoBehaviour {
	...
	public void DeactivateUIImage() 
	{
		...
		{
			hudCanvas.transform.Find("Food5").Find("FoodImage").gameObject.SetActive(false);
		}
		else if(foodList.Count == 6)
		{
			hudCanvas.transform.Find("Food6").Find("FoodImage").gameObject.SetActive(false);
		}
		else if(foodList.Count == 7)
		{
			hudCanvas.transform.Find("Food7").Find("FoodImage").gameObject.SetActive(false);
		}
	...
	public void UpdateList()
	{
		...
		for(int i = 0; i < foodList.Count; i++)
		{
			...
			else if(foodList.Count == 6)
			{
				...
				{
					hudCanvas.transform.Find("Food5").Find("FoodImage").gameObject.SetActive(true);
					hudCanvas.transform.Find("Food5").Find("FoodImage").gameObject.GetComponent<Image>().sprite = foodList[i].GetComponent<SpriteRenderer>().sprite;
				}
				else if(i == 5)
				{
					hudCanvas.transform.Find("Food0").Find("FoodImage").gameObject.SetActive(true);
			...
			else if(foodList.Count == 7)
			{
				...
				{
					hudCanvas.transform.Find("Food6").Find("FoodImage").gameObject.SetActive(true);
					hudCanvas.transform.Find("Food6").Find("FoodImage").gameObject.GetComponent<Image>().sprite = foodList[i].GetComponent<SpriteRenderer>().sprite;
				}
				else if(i == 6)
				{
					hudCanvas.transform.Find("Food0").Find("FoodImage").gameObject.SetActive(true);
			...
			else if(foodList.Count == 8)
			{
				...
				{
					hudCanvas.transform.Find("Food7").Find("FoodImage").gameObject.SetActive(true);
					hudCanvas.transform.Find("Food7").Find("FoodImage").gameObject.GetComponent<Image>().sprite = foodList[i].GetComponent<SpriteRenderer>().sprite;
				}
				else if(i == 7)
				{
					hudCanvas.transform.Find("Food0").Find("FoodImage").gameObject.SetActive(true);
